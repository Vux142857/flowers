    ...
    <>
      <div className="flex flex-col lg:flex-row border-t-[1px] border-black">
        ...
        <div className='lg:w-1/2 flex flex-col p-20 border-r-[1px] border-black lg:sticky lg:top-0 justify-start items-start'>
          <h2 className="text-mobile-heading-2 lg:text-heading-2 text-start animate-on-scroll">About us</h2>
        </div>
        {/* Right */}
        <div className='lg:w-1/2 flex flex-col p-20 gap-16 items-start justify-between'>
          <div className="flex flex-col text-start gap-6">
            <p className="text-overline">OUR STORY</p>
            <h3 className="text-mobile-heading-3 lg:text-heading-3 animate-on-scroll">Kyiv LuxeBouquets</h3>
            <span className="text-mobile-body lg:text-bodtext-mobile-body animate-on-scroll">
