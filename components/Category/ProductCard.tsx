...
const ProductCard: React.FC<ProductCardProps> = (props) => {
  return (
    <Link href={`/product/${props.slug}?id=${props.id}`} className={`w-full flex items-center justify-center relative border-[0.5px] ${props.isMain ? 'border-black' : 'border-ligh'} overflow-hidden`}>
